...
class AcesArguments:
    ...
    num_solutions: int = field( default = 100, metadata={"help": "number of solutions to generate to compute the difficulty score"})
    ...
    mode_sampling_goal: str = field( default = "uniform", metadata={"help": "['uniform','smart','none'], uniform sample goal uniformely, smart: sample unexplored goal close that are within 1 of distance of already explored goal in the semantic space"})
